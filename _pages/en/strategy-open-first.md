...
We want to build stronger ties with Canadians by being more transparent and by building solutions together.
...
There are two categories of software that are considered to conform to these standards: 
...
The Government is once again well positioned to rally the country into the growing IT field of open standards and OSS that employs tens of thousands of people across the country.
...
It must become digitally autonomous in its decisions while leveraging all possible options when devising its solutions.
...
Canada has established a clear vision and designed its policies to nudge departments towards it.
